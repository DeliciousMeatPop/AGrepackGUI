...
; *** But this version for AG, was done by ToMattBan ***
;
...
; *** SetupLdr messages
SetupLdrStartupMessage=%1 será instalado no seu computador. Você deseja continuar?
...
PowerUserPrivilegesRequired=Você deve estar logado como administrador ou como um membro do grupo de Usuários Power para instalar este programa.
SetupAppRunningError=O Instalador detectou que %1 está atualmente em execução.%n%nPor favor o feche, então clique em OK para continuar ou em Cancelar para sair.
UninstallAppRunningError=O Desinstalador detectou que %1 está atualmente em execução.%n%nPor favor o feche, então clique em OK para continuar ou em Cancelar para sair.
...
PrivilegesRequiredOverrideText1=%1 pode ser instalado para todos os usuários (requer privilégios administrativos) ou só para você.
PrivilegesRequiredOverrideText2=%1 pode ser instalado só para você ou para todos os usuários (requer privilégios administrativos).
...
PrivilegesRequiredOverrideCurrentUser=Instalar só &para mim
PrivilegesRequiredOverrideCurrentUserRecommended=Instalar só &para mim (recomendado)
...
WelcomeLabel2=[name/ver] será instalado no seu computador.%n%nÉ recomendado que você feche todos os outros aplicativos antes de continuar.
...
LicenseLabel=Leia as seguintes informações antes de continuar.
LicenseLabel3=Leia o seguinte Acordo de Licença. Você deve aceitar os termos deste acordo antes de continuar com a instalação.
...
DiskSpaceMBLabel=Pelo menos [mb] MBs de espaço livre é necessário.
...
DiskSpaceWarningTitle=Sem Espaço em Disco Suficiente
DiskSpaceWarning=O Instalador requer pelo menos %1 KBs de espaço livre para instalar mas o disco selecionado só tem %2 KBs disponíveis.%n%nVocê quer continuar de qualquer maneira?
...
SelectComponentsLabel2=Selecione os componentes que você quer instalar; desmarque os componentes que você não quer instalar. Clique em Próximo quando você estiver pronto para continuar.
...
ComponentsDiskSpaceMBLabel=A seleção atual requer pelo menos [mb] MBs de espaço disponível.
...
ReadyLabel1=O Instalador está agora pronto para começar a instalação.
...
PreparingDesc=O Instalador está se preparando para instalar [name] no seu computador.
PreviousInstallNotCompleted=A instalação/remoção de um programa anterior não foi completada. Você precisará reiniciar o computador para completar essa instalação.%n%nApós reiniciar seu computador execute o Instalador de novo para completar a instalação de [name].
...
ErrorCloseApplications=O instalador foi incapaz de fechar automaticamente todos os aplicativos. É recomendado que você feche todos os aplicativos que estejam usando os arquivos que precisam ser atualizados pelo Instalador antes de continuar.

; *** "Installing" wizard page
WizardInstalling=Instalando
InstallingLabel=Por favor espere enquanto [name] é instalado em seu computador.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Completando o Instalador de [name]
FinishedLabelNoIcons=O Instalador terminou de instalar o [name] no seu computador.
FinishedLabel=O Instalador terminou de instalar [name] no seu computador. O aplicativo pode ser iniciado selecionando os atalhos instalados.
ClickFinish=Clique em Concluir para sair do Instalador.
FinishedRestartLabel=Para completar a instalação de [name], o Instalador deve reiniciar seu computador. Você gostaria de reiniciar agora?
FinishedRestartMessage=Para completar a instalação de [name], o Instalador deve reiniciar seu computador.%n%nVocê gostaria de reiniciar agora?
...
ErrorFunctionFailed=%1 falhou; codigo %2
ErrorFunctionFailedWithMessage=%1 falhou; codigo %2.%n%3
...
ExistingFileNewer=O arquivo existente é mais recente do que o arquivo que o Instalador está tentando instalar. É recomendado que você mantenha o arquivo existente.%n%nVocê quer manter o arquivo existente?
...
UninstallNotFound=O arquivo "%1" não existe. Não foi possível desinstalá-lo.
UninstallOpenError=O arquivo "%1" não pôde ser aberto. Não foi possível desinstalá-lo
UninstallUnsupportedVer=O arquivo do log da desinstalação "%1" está num formato não reconhecido por esta versão do desinstalador. Não foi possível desinstalá-lo
...
CreateQuickLaunchIcon=Criar um atalho na &barra de tarefas
