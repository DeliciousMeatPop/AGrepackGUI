...
;
; Translated to Ukrainian by @pr_liv
;
...
; *** Application titles
SetupAppTitle=Інсталляція
SetupWindowTitle=Інсталляція - %1
UninstallAppTitle=Деінсталляція
UninstallAppFullTitle=%1 Деінсталляція
...
; *** SetupLdr messages
SetupLdrStartupMessage=Ця програма встановить %1 на ваш комп'ютерб бажаєте продовжити?
...
SetupFileMissing=Файл %1 відсутній у папці установки. Будь ласка, виправіть проблему або отримайте нову копію програми.
SetupFileCorrupt=Файли інсталляції пошкоджені. Будь ласка отримайте нову копію програми.
SetupFileCorruptOrWrongVer=Файли інсталляції пошкоджені, або не є сумісними із даною версією програми інсталляції. Будьласка, виправіть проблему або отримайте нову копію програми.
InvalidParameter=Командна строка отримала недопустимий параметр:%n%n%1
SetupAlreadyRunning=Інсталлятор уже запущено.
WindowsVersionNotSupported=Ця програма на підтримує версію Windows, встановлену на цьому комп'ютері.
WindowsServicePackRequired=Ця програма потребує %1 Service Pack %2 або вище.
NotOnThisPlatform=Ця програма не буде працювати в %1.
OnlyOnThisPlatform=Цю програму можна запустити лише в %1.
OnlyOnTheseArchitectures=Цю програму можна запустити лише на версіях Windows яка підтримує наступні архітектури процессора:%n%n%1
...
AdminPrivilegesRequired=Щоби інсталювати цю програму ви маєте ввійти у систему як Адміністратор.
PowerUserPrivilegesRequired=Щоби інсталювати цю програму ви маєте ввійти у систему як Адміністратор або член групи «Досвідчені Користувачі» (Power Users).
SetupAppRunningError=Виявлено що %1 вже запущено.%n%nБудьласка, зайрийте усі копії програми, та натисніть «OK», щоби продовжити та «Скасувати» щоби вийти.
UninstallAppRunningError=Виявлено що %1 вже запущено.%n%nБудьласка, зайрийте усі копії програми, та натисніть «OK», щоби продовжити та «Скасувати» щоби вийти.

; *** Startup questions
PrivilegesRequiredOverrideTitle=Вибір режиму установки
PrivilegesRequiredOverrideInstruction=Виберіть режим установки
...
PrivilegesRequiredOverrideText2=%1 може бути встановлено тільки для вас, або для усіх користувачів (потребує права адміністратора).
...
; *** Misc. errors
ErrorCreatingDir=Програмі не вдалося створити теку "%1"
ErrorTooManyFilesInDir=Не вдалося створити файл у теці "%1", тому що в ній забагато файлів                  

; *** Setup common messages 
ExitSetupTitle=Вихід з програми встановлення
ExitSetupMessage=Встановлення не завершено. Якщо ви вийдете зараз, програма не буде встановлена.%n%nВи можете відкрити програму встановлення пізніше.%n%nВийти з програми встановлення?
...
AboutSetupNote=
TranslatorNote=Ukrainian translation by existenz
...
SelectLanguageLabel=Виберіть мову, яка буде використовуватись під час встановлення.
...
FileExists=Файл існує.%n%nWould бажаєте його перезаписати?
ExistingFileNewer=Існуючий файл новіший, ніж встановлюваємий. Рекомендується залишити існуючий файл.%n%nDo бажаєте залишити існуючий файл?
...
ErrorReplacingExistingFile=Виникла помилка при спробі замініти існуючий файл:
...
UninstallDisplayNameMarkCurrentUser=Поточкий користувач
